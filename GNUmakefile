...
#	install -m 644 man/man1/execwsock.1 "$(INSTDIR)"/share/man/man1/
#ifeq ($(COMPRESS_MAN),yes)
#	rm -f "$(INSTDIR)"/share/man/man1/execwsock.1.gz
#	gzip "$(INSTDIR)"/share/man/man1/execwsock.1
#endif

deinstall:
	rm -f "$(INSTDIR)"/lib/rc/execwsock "$(INSTDIR)"/share/man/man1/execwsock.1{,.gz}
